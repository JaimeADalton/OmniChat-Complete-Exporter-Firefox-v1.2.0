...
report={'version':'1.3.2','environment':'Chromium popup DOM, browser APIs simulated','firefox_live_test':False,'tests':[]}
with sync_playwright() as p:
 ...
 page.evaluate('''() => {
  ...
  window.__report={version:'1.3.2',phase:'binary_preflight',message:'TEST-ERROR',stack:'content/content.js:120:1'};
  window.browser={
